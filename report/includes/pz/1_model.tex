...
\begin{figure}[!h]
    \centering
    \includegraphics[width=23cm, angle=90]
        {assets/ARIS/ARIS_OrganizationalСhart.adf.pdf}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{1.2cm}|M{4cm}|p{4cm}|M{7cm}|} 
        ...
        1.1.1   &Инвентаризация                         &Начальство, мастера&\\ \hline
        1.1.1.1 &Создание инвентаризационной комиссии   &Начальство, мастера&
        СПР\_МестаХранения,
        ДОК\_ПриказСоздИнвентКомис\\ \hline
        1.1.1.2 &Проведение инвентаризации              &Начальство, мастера&ДОК\_ИнвентОпись\\ \hline
        1.1.1.3 &Выдача отчёта инвентаризации           &Начальство, мастера&ОТЧ\_АктНедостТов\\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|M{0.7cm}|p{3.1cm}|p{5cm}|p{2cm}|p{5cm}|} 
        ...
        5&ДолжностиСотру дникаId&Должность сотрудника&N16&СПР\_ДолжностиСотру дника\\ \hline
    \end{tabular}
\end{table}
